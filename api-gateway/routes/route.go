...
func Setup(
	...
	api.Post("/user/search", middleware.JWTMiddleware(jwt), userHandler.GetUsersByEmail)
	...
	api.Delete("/friend/:id", middleware.JWTMiddleware(jwt), userHandler.DeleteFriend)
