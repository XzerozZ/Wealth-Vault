...
type InvestmentUsecase interface {
	...
	GetBatchInvestmentByIDs(ctx context.Context, req *pb.GetBatchIdsRequest) (*pb.InvestmentArrayResponse, error)
	...
	CleanupExpiredInvestment(ctx context.Context) error
}
